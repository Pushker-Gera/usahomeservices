...
export default function PrivacyPolicyPage() {
  return <Legal title="Privacy Policy" updated="May 18, 2026" paragraphs={[
    "At usahomeservices, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information when you visit our website or use our services.",
